<!-- 
  ...
  <div style="display: none;">
  	<div id="almi-modal" class="box-modal almi-modal">
  		<div class="almi-modal__close box-modal_close arcticmodal-close">Close</div>
  		<div class = "almi-modal__body">
  			<div class="almi-modal__image" style = "background: url(<?php bloginfo('template_url');?>/img/almi-modal-bg.jpg); background-position:bottom center;">
  				<div class="almi-modal__dg">
  					<img src="<?php echo get_template_directory_uri();?>/img/almi-modal-img.png" class="spacer" alt="">
  				</div>
  			</div>
  			<h3>
  ...
  <div style="display: none;">
  	<div class="box-modal" id="order-modal">
  		...
  		<div class = "modalline" id = "lineIcon">
  			<form action="">
  				<h3 class="popup__title_text">Get a consultation</h3>
  				<input type="text" class="inputbox" name="name" placeholder="Name">
